...
namespace Page_Navigation_App.ViewModel
{
    class NavigationVM : ViewModelBase
    {
        ...
        //esp
        public ICommand ESP32ConfigCommand { get; set; }
        public ESP32Config ESP32ConfigView { get; set; }
        ...
        public NavigationVM()
        {
            ...
            //esp
            ESP32ConfigView = new ESP32Config();
            ESP32ConfigCommand = new RelayCommand(o => { CurrentView = ESP32ConfigView; });
        }
    }
}
